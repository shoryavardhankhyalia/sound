function soundClassification()
{
    ...
    classifier = ml5.soundClassifier('https://teachablemachine.withgoogle.com/models/QbhxONRRTz/model.json',modelReady);
}
function modelReady()
{
...
function gotResults(error,results)
{
    ...
    else
    {
        ...
        document.getElementById("result_label").style.color = "rgb("+random_number_b+","+random_number_r+","+random_number_g+")";
